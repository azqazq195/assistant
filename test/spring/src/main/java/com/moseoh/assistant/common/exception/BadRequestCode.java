...
//    ROLE_NAME_NOT_FOUND(1003, "해당 이름을 가진 역할이 없습니다.", RoleNameNotFoundException.class),
    USER_NOT_FOUND("1004", "해당 ID를 가진 유저가 없습니다.", UserNotFoundException.class);
...
//    ABILITY_PARENT_COLOR_DUPLICATE(4003, "중복된 색상의 부모역량이 존재합니다.", AbilityParentColorDuplicateException.class),
//    ABILITY_PARENT_CHILD_COLOR_DIFFERENT(4004, "상위 역량과 하위 역량의 색상이 일치하지 않습니다.", AbilityParentChildColorDifferentException.class),
...
//    GRAPH_ABILITIES_ARE_NOT_PARENT_EXCEPTION(4007, "그래프의 역량은 부모 역량만 등록 가능합니다.", GraphAbilitiesAreNotParentException.class),
...
//    UNRELATED_ABILITY_EXISTENCE_EXCEPTION(4011, "역량 그래프와 관련이 없는 역량이 스터디 로그 역량에 존재합니다.", UnRelatedAbilityExistenceException.class),
