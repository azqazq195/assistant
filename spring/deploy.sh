...
docker run -d -p 9090:9090 --name=assistant_server --restart=always -v /var/log/assistant_server:/var/log -v /var/run/docker.sock:/var/run/docker.sock -v assistant_server_data:/data azqazq195/assistant_server